                ...
                <div class="o-grid__cell o-grid__cell--width-70">
                    <div class="c-card">
                        <div class="c-card__body">
                            <p class="c-paragraph"><?= Loc::getMessage('D2F_DRAGDROP_LABEL_TITLE_HELP_BEGIN') ?>.</p>
                            <?= Loc::getMessage('D2F_DRAGDROP_LABEL_TITLE_HELP_BEGIN_TEXT'); ?>
                        </div>
                    </div>
                    <div class="o-container--large">
                        <h2 id="yaPay"
                            class="c-heading u-large"><?= Loc::getMessage('D2F_DRAGDROP_LABEL_TITLE_HELP_DONATE_TEXT'); ?></h2>
                        ...
                        <h2 id="morePay"
                            class="c-heading u-large"><?= Loc::getMessage('D2F_DRAGDROP_LABEL_TITLE_HELP_DONATE_ALL_TEXT'); ?></h2>
                        <table class="c-table">
                        ...
                        <h2 id="moreThanks"
                            class="c-heading u-large"><?= Loc::getMessage('D2F_DRAGDROP_LABEL_TITLE_HELP_DONATE_OTHER_TEXT'); ?></h2>
                        <?= Loc::getMessage('D2F_DRAGDROP_LABEL_TITLE_HELP_DONATE_OTHER_TEXT_S'); ?>
                    </div>
                </div>
                <div class="o-grid__cell o-grid__cell--width-30">
                    <h2 id="moreThanks"
                        class="c-heading u-large"><?= Loc::getMessage('D2F_DRAGDROP_LABEL_TITLE_HELP_DONATE_FOLLOW'); ?></h2>
                    <table class="c-table">
